	...
	public static void main(String[]args)
	{
		...
		if( firstcase == 1)
		{
			...
			if( Window1 == 1)
			{
				...
				System.out.println("\n Who's that? Stop right there! Get em!");
				System.out.println("\n You frantically try to open Betsy's door but you realize that you didn't have the keys. You idiot. The raiders grab you and throw you into a sack. They threw you too roughly. You ded.");
			}
			else 
			...
			int hide = kb.nextInt();
				...
				else
				{
					...
					System.out.println("\n Uniformed individuals jump out of the cars. \"Is there anyone else that needs assistance? Are you the only captive?\" You simply nod and hop into the cars and speed off to safety. You're safe!");
				}
		}
		if (firstcase == 2)
			{
